...
func (Patient_Gender) EnumDescriptor() ([]byte, []int) {
	return file_patients_service_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *RangeRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type Patient struct {
	...
	BirthDate         *Patient_Date               `protobuf:"bytes,8,opt,name=birth_date,json=birthDate,proto3" json:"birth_date,omitempty"`
...
func (x *Patient) GetBirthDate() *Patient_Date {
	if x != nil {
		return x.BirthDate
	}
	return nil
...
func (x *Patient_Date) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Patient_Date) ProtoMessage() {}

func (x *Patient_Date) ProtoReflect() protoreflect.Message {
	mi := &file_patients_service_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Patient_Date.ProtoReflect.Descriptor instead.
func (*Patient_Date) Descriptor() ([]byte, []int) {
	return file_patients_service_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Patient_Date) GetDay() int32 {
	if x != nil {
		return x.Day
	}
	return 0
...
func (x *Patient_Date) GetMonth() int32 {
	if x != nil {
		return x.Month
	}
	return 0
...
func (x *Patient_Date) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (*Patient_EmergencyContact) Descriptor() ([]byte, []int) {
	return file_patients_service_proto_rawDescGZIP(), []int{2, 2}
}
...
var file_patients_service_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x22, 0x52, 0x0a, 0x0c, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x36, 0x0a, 0x0e, 0x50, 0x61, 0x74, 0x69, 0x65, 0x6e,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0xda,
	0x05, 0x0a, 0x07, 0x50, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x65, 0x72, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x49, 0x64, 0x52, 0x0a, 0x70, 0x65, 0x72, 0x73, 0x6f,
	...
	0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x0a, 0x62, 0x69, 0x72, 0x74,
	0x68, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70,
	0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x50, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x2e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x1a, 0x42, 0x0a, 0x04, 0x44, 0x61,
	...
	0x61, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x79, 0x65, 0x61, 0x72, 0x1a, 0x5a,
	...
	,
...
var file_patients_service_proto_goTypes = []interface{}{
	...
	(*RangeRequest)(nil),             // 1: patients.RangeRequest
	(*PatientRequest)(nil),           // 2: patients.PatientRequest
	(*Patient)(nil),                  // 3: patients.Patient
	(*Patient_PersonalId)(nil),       // 4: patients.Patient.PersonalId
	(*Patient_Date)(nil),             // 5: patients.Patient.Date
	(*Patient_EmergencyContact)(nil), // 6: patients.Patient.EmergencyContact
}
var file_patients_service_proto_depIdxs = []int32{
	4, // 0: patients.Patient.personal_id:type_name -> patients.Patient.PersonalId
	0, // 1: patients.Patient.gender:type_name -> patients.Patient.Gender
	5, // 2: patients.Patient.birth_date:type_name -> patients.Patient.Date
	6, // 3: patients.Patient.emergency_contacts:type_name -> patients.Patient.EmergencyContact
	2, // 4: patients.PatientsService.GetPatient:input_type -> patients.PatientRequest
	1, // 5: patients.PatientsService.GetPatients:input_type -> patients.RangeRequest
	3, // 6: patients.PatientsService.GetPatient:output_type -> patients.Patient
	3, // 7: patients.PatientsService.GetPatients:output_type -> patients.Patient
